            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a id="create" class="btn sbold green btn-outline" href="{{url('admin/role/create')}}"><span class="fa fa-pencil"></span> Create Role</a>
                            </div>
                        </div>    
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach($roles as $item)
                            <tr class="odd gradeX">
                                ...
                                <td>{{$item->source}}</td>                        
                                <td class="center"><div ><a class='edit' href="{{url('admin/role/'.$item->id).'/edit'}}" data-id="{{$item->id}}"><span class="fa fa-pencil-square"></span></a></div></td>
